...
<html lang="en">
  <head>
    ...
    <meta name="google-site-verification" content="8APSj9nh5dIU5bJSDV96o0iGk7pyaIxZWQVbdnbDEvY" />
    <link rel="icon" href="favicon.ico">

    <title>Data Monetization Solutions</title>
        ...
        <nav class="navbar navbar-inverse navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">Data Monetization Solutions</a>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <li class="active"><a href="#">Home</a></li>
                <li><a href="#analytic">Analytic Solutions</a></li>
                <li><a href="#computing">Computing Solutions</a></li>
                <li><a href="#devops">Dev-Ops Solutions</a></li>
